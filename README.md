...
| **PersonaChat** | Single-session persona-grounded dialogues. Persona facts are the ground-truth target for extraction. | https://huggingface.co/datasets/bavard/personachat_truecased |
